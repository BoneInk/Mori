...
tags: [mirror, markdown]
---

# Markdown compatibility

Mirror supports common Markdown and GFM writing patterns, safe HTML, tables, task lists, code highlighting, footnotes, offline diagrams, and offline mathematics.
...
[Reference links][guide], [collapsed references][], and shortcut-style [Mirror] references are supported throughout the document, including inside quotes and lists.
